...
#details_df.to_csv(r'location\filename.csv.csv', index = False)
...
#trial_items.to_csv(r'location\filename.csv', index = False)

#items_df.to_csv(r'location\filename.csv', index = False)

#product_df.to_csv(r'location\filename.csv.csv', index = False)
